...
const urls = {
  loading: process.env.PUBLIC_URL + '/images/ic_loading.gif',
  ...
  like: process.env.PUBLIC_URL + '/images/ic_like.png',
  medium: process.env.PUBLIC_URL + '/images/ic_medium.png',
  twitter: process.env.PUBLIC_URL + '/images/ic_twitter.png',
  reddit: process.env.PUBLIC_URL + '/images/ic_reddit.png',
  telegram: process.env.PUBLIC_URL + '/images/ic_telegram.png',
  backArrow: process.env.PUBLIC_URL + '/images/ic_arrow.png',
  shareBox: process.env.PUBLIC_URL + '/images/ic_share_box.png',
